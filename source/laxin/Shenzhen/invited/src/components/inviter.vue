<template>
  <div class="inviter">
    <div class="inviter_top relative">
      <img class="relative" src="../assets/images/invite-04 2@2x_1.png" alt />
      <div class="inviter_rule" @click="g_regulation()">
        <img class="absolute" src="../assets/images/分组@2x.png" alt />
      </div>
      <div class="inviter_time inviter_time_1 absolute">活动时间：2019.07.12-2019.08.12</div>
    </div>

    <div class="inviter_invitation relative">
      <img class="absolute" src="../assets/images/letter@2x (1).png" alt />
      <div class="charge absolute">
         <ul>
          <li class="g_separation">每邀请一位好友首次购买您将获得</li>
          <li class="g_gap">7天免费换电</li>
          <li class="g_interval">邀请的好友数量越多，获得奖励越多</li>
        </ul>
        <ul class="charge_ul">
          <li class="g_separation_1">被邀请人可获得</li>
          <li class="g_gap_1">50元优惠券</li>
          <li class="g_interval_1">购买299包月套餐可用</li>
        </ul>
      </div>
